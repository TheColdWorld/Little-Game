       ...
       await System.Threading.Tasks.Task.Run(() =>
        {
            ...
            {
                LogLevel.Debug => string.Format("[{0}][{1}/{2}][{3}] : {4}", System.DateTime.Now.ToString(), ThreadName, "Debug", AtClass.FullName, Message),
                LogLevel.Info => string.Format("[{0}][{1}/{2}][{3}] : {4}", System.DateTime.Now.ToString(), ThreadName, "Info", AtClass.FullName, Message),
                LogLevel.Warm => string.Format("[{0}][{1}/{2}][{3}] : {4}", System.DateTime.Now.ToString(), ThreadName, "Warm", AtClass.FullName, Message),
                LogLevel.Error => string.Format("[{0}][{1}/{2}][{3}] : {4}", System.DateTime.Now.ToString(), ThreadName, "Error", AtClass.FullName, Message),
                LogLevel.FatalError => string.Format("[{0}][{1}/{2}][{3}] : {4}", System.DateTime.Now.ToString(), ThreadName, "Fatal Error", AtClass.FullName, Message),
                _ => "\n"
            };
